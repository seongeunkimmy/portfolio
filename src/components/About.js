    ...
    return (
        <section id="about" className="text-gray-400 bg-gray-900 body-font my-10">
         ...
         <Fade left duration={750} delay={500}>
            ...
            <div className="w-3/5 lg:w-72 sm:w-1/2 flex flex-col mx-12 my-8 md:my-0">
           ...
           <a href="images/RESUME(KIM).pdf" download> <button className="mt-12 place-self-center w-38 bg-transparent hover:bg-purple-500 text-purple-400 font-semibold hover:text-white py-3 px-5 border-2 border-purple-600 hover:border-transparent">CV DOWNLOAD</button></a>
