...
<div className="flex flex-col w-full mb-20 justify-center items-center"> 
     ...
     <a href="https://www.linkedin.com/in/seongeun-kim/" target="_blank"><FaLinkedinIn className="m-2 w-10 h-8 text-white text-3xl hover:animate-fade-in-down"/></a>
      <a href="https://github.com/seongeunkimmy" target="_blank"><FaGithub className="m-2 w-10 h-8 text-white text-3xl hover:animate-fade-in-down"/></a>
